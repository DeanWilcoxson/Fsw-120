...
function App() {
  return (
    <div>
      <Component title="Dean; " subtitle="Color" backgroundColor="Blue: " information="Dean's Favorite Color"/>
      ...
      <Component title="Hair; " subtitle="Color" backgroundColor="Brown: " information="Dean's Hair Color"/>
      <Component title="Dean2; " subtitle="Color" backgroundColor="Grey: " information="Dean's Second Favorite Color"/>
    </div>
  );
}
export default App;
